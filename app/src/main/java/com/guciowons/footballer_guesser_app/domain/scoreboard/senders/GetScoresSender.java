...
public class GetScoresSender {
    public static void fetchScores(ScoreboardViewModel viewModel, String time, Integer leagueId, RequestQueue requestQueue) {
        ...
        requestQueue.add(scoresRequestManager.getScores(viewModel, createUrl(time, leagueId, requestQueue)));
    }

    private static String createUrl(String time, Integer leagueId, RequestQueue requestQueue){
